...
ui <-(fluidPage( titlePanel("Height Pediction"),
                 sidebarLayout( sidebarPanel(helpText("Prediction of the child's height based on gender and parent's height"),
                                             helpText("Parameters:"),
